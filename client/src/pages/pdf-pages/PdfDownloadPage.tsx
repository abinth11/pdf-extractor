    ...
    <div className='flex flex-col justify-center items-center w-full h-full'>
      ...
      <div className='p-10 flex items-center justify-center flex-col'>
        ...
        <div className='md:mt-10 mt-5 flex items-center '>
          ...
          <button
            className='bg-primary flex w-[18rem] items-center justify-center hover:bg-secondary text-xl md:text-2xl py-[1.5rem] rounded-xl text-white font-semibold'
          ...
          <div className='flex flex-col justify-between h-[4.9rem]'>
            ...
            <div
              ...
              } bg-primary rounded-full p-2 ml-2.5 shadow-lg hover:bg-secondary hover:cursor-pointer`}
            >
